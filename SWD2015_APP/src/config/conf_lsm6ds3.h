 ...
 * conf_lsm6ds3.h
 *
 * Created: 2/19/2016 3:35:27 PM
 *  Author: Panmaya
 */ 


#ifndef CONF_LSM6DS3_H_
#define CONF_LSM6DS3_H_

#define LSM6DS3_ADDRESS                (0x6A<<1)   // 110 1010 (Assumes SDO/SA0 = GND)
#define LSM6DS3_READBIT                (0x01)
#define LSM6DS3_POLL_TIMEOUT           (100)       // Maximum number of read attempts in lis3dhPoll()

/**
* \name TWIx pin definitions
* @{
	*/
/*! TWI ID for LSM6DS3 application to use */
#define BOARD_ID_TWI_LSM6DS3			ID_TWI1

/*! TWI Base for TWI LSM6DS3 application to use */
#define BOARD_BASE_TWI_LSM6DS3		TWI1
#define BOARD_LSM6DS3_TWI_INSTANCE	TWI1
#define BOARD_LSM6DS3_ADDRESS		0x6A//LSM6DS3_ADDRESS

/*! TWI1 Data pin for LSM6DS3 */
#define TWI1_DATA_GPIO				PIO_PB4_IDX
#define TWI1_DATA_FLAG				IOPORT_MODE_MUX_A
/*! TWI1 Clock pin for LSM6DS3 */
#define TWI1_CLK_GPIO				PIO_PB5_IDX
#define TWI1_CLK_FLAG				IOPORT_MODE_MUX_A
#define BOARD_CLK_TWI_LSM6DS3		TWI1_CLK_GPIO
#define BOARD_CLK_TWI_MUX_LSM6DS3	TWI1_CLK_FLAG
